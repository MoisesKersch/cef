...
jQuery.validator.addMethod("cnpj", function (value, element, options) {
    return isCnpj(value);
}, "CNPJ inválido!");

jQuery.validator.addMethod("cpf", function (value, element, options) {
    return isCpf(value);
}, "CPF inválido!");

jQuery.validator.addMethod("cpfcnpj", function (value, element, options) {
...
jQuery.validator.addMethod(
		...
		"Por favor, forneça uma data válida DD/MM/YYYY"
);

jQuery.validator.addMethod(
	"isNotTodaysDate",
	function(value, element) {
		var input = new Date( moment(value, "DD-MM-YYYY"));
		var today = new Date();
		if (input >= today) {
			return true;
		} else return false;
	},
	"Por favor, forneça uma data maior que o dia de hoje."
);

jQuery.validator.addMethod("percentages", function(value, element) {
    if (table.data().count() > 0) return true;
}, "Por favor adicione pelo menos uma porcentagem.");
